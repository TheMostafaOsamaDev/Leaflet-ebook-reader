...
export const ar: Messages = {
  ...
  "reader.endOfChapter": "نهاية الفصل",
  "reader.endOfBook": "نهاية الكتاب",
  "reader.savedOnDevice": "محفوظ على الجهاز",
  ...
  "highlights.deleteConfirm": "تأكيد الحذف؟",
  "highlights.deleteShort": "حذف",
  ...
  "selection.copy": "نسخ",
  "selection.copied": "تم النسخ",
  "selection.writeNote": "اكتب ملاحظة…",
  "selection.colorsAriaLabel": "ألوان التظليل",
  "selection.noteAriaLabel": "ملاحظة على المقطع المحدد",
  "color.yellow": "أصفر",
  "color.blue": "أزرق",
  "color.pink": "وردي",
  "color.green": "أخضر",
